...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pictureBox1->Size = System::Drawing::Size(512, 520);
			...
			this->label1->Location = System::Drawing::Point(607, 30);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(296, 63);
			this->label1->TabIndex = 1;
			this->label1->Text = L"Pixelmaker";
			// 
			// label2
			// 
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label3->Location = System::Drawing::Point(554, 488);
